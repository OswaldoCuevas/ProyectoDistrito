			...
			const password_return = password_definitivo	
			clean_password()
return password_return;
			}
			function clean_password(){
				 tamanyo_password				=	9;			// definimos el tamaño que tendrá nuestro password
				 ...
				 numero_minimo_letras_minusculas	=	1;			// en ésta y las siguientes variables definimos cuántos 
				 numero_minimo_letras_mayusculas	=	1;			// caracteres de cada tipo queremos en cada 
				 numero_minimo_numeros			=	1;
				 numero_minimo_simbolos			=	1;
	
				 letras_minusculas_conseguidas 	=	0;
					letras_mayusculas_conseguidas	=	0;
					numeros_conseguidos				=	0;
					simbolos_conseguidos			=	0;
			}

export {generar_contraseña}
