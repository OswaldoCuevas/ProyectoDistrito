...
$(document).ready(function() {  
    ...
    function data_change_location (){
        ...
        <div>
            ...
            <input  type="text" maxlength="30"  id="Cologne" value="${Cologne}" class="swal2-input col-5">
        </div>

        <div>
            <label for = "Plot">Lote</label>
            <input  type="text" maxlength="20" id="Plot" value="${Plot}" class="swal2-input col-5">
        </div>

        <div>
            <label for = "Latitude">Latitúd</label>
            <input  type="text"  id="Latitude" maxlength="20" value="${Latitude}" class="swal2-input col-5">
        </div>
        <div>
            <label for = "Longitude">Longitúd</label>
            <input  type="text"  id="Longitude" maxlength="20" value="${Longitude}" class="swal2-input col-5">
        </div>    
        <div> 
