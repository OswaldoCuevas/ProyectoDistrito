...
?>
<link rel="stylesheet" href="../css/titulosSectioUsuario.css">
    ...
    <div class="titulo" id="<?php echo  $_POST['Title_Id']?>">
            <div class="container-section">
                ...
                <div class="container-titulo">
                    ...
                    <h6 class="name"><b><?php echo $Title[0]['Title_Number'] ?></b></h6>
                </div>
        ...
        <div class="titular">
            <div class="container-section">
                ...
                <div class="container-titular">
                    ...
                    <h6 class="name" id="Username"><b><?php echo cutWord($Title[0]['Full_Name'],30) ?></b></h6>
                </div>
